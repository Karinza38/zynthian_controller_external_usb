...
ENCODER_CREATE(back, ',', '.', KEY_LEFT_CTRL, KEY_NONE, KEY_BACKSPACE, KEY_NONE, KEY_LEFT_SHIFT, KEY_LEFT_CTRL );
...
ENCODER_CREATE(snap, '<', '>', KEY_LEFT_SHIFT, KEY_NONE, 'o', KEY_NONE, KEY_LEFT_SHIFT, KEY_LEFT_CTRL );

ENCODER_DEF_PIN_MAP(select,ENC3_GND,ENC3_VCC,ENC3_SW,ENC3_A,ENC3_B);
ENCODER_CREATE(select, ',', '.', KEY_NONE, KEY_NONE, 'l', KEY_NONE, KEY_LEFT_SHIFT, KEY_LEFT_CTRL );
/***********************************************/
